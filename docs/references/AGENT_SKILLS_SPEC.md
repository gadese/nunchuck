...
source: "https://github.com/agent-skill/agent-skill/blob/main/SPEC.md"
purpose: >
  This document serves as an internal reference for the Agent Skills format.
  It is should never be altered or modified.
---
