...
def cmd_help() -> int:
    print("sniff-oo-abusers commands:")
    print("  help")
    print("  validate")
...
def cmd_validate() -> int:
    ...
    print("ok: sniff-oo-abusers cli is runnable")
    return 0
...
def cmd_scan(args: argparse.Namespace) -> int:
    ...
    n = scan_group(repo_root, "oo_abusers", thresholds=thresholds)
...
def main(argv: list[str]) -> int:
    ...
    p_scan.add_argument("--threshold", action="append", default=[], help="override threshold, e.g. switch_keyword_count=20")
