...
def cmd_validate() -> int:
    ...
    print("ok: sniff-couplers cli is runnable")
    return 0
...
def cmd_scan(args: argparse.Namespace) -> int:
    ...
    n = scan_group(repo_root, "couplers", thresholds=thresholds)
...
def main(argv: list[str]) -> int:
    ...
    p_scan.add_argument("--threshold", action="append", default=[], help="override threshold, e.g. message_chain_depth=5")
