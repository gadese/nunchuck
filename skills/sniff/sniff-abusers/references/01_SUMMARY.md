---
description: What sniff-abusers does and does not do.
index:
  - What it does
  - What it is not
---
...
`sniff-abusers` scans tracked files for a minimal set of OO abusers smells using deterministic, cheap heuristics. It appends findings to `.sniff/findings.jsonl` and regenerates `.sniff/index.json`.
