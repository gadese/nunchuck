...
function Invoke-Validate {
    ...
    Write-Output "ok: md skill is runnable"
}
...
function Invoke-Dispatch {
    ...
    Push-Location $IncludeDir
    try {
        & uv run python md_cli.py @Arguments
    } finally {
        Pop-Location
    }
}
